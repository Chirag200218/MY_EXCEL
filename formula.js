...
for(let i=0;i<rows;i++){  //for updating cellProp value after we have wrtiiten value in cell container
...
formulaBar.addEventListener("keydown",async (e)=>{
    if(e.key==="Enter" && formulaBar.value){
        ...
        //If change in formula from previous formula,break old Parent-Child relation,evaluate new formula, add new Parent-Child relation
