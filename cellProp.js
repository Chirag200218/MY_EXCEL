...
let sheetDB =[];// a 2-d matrix where we are storing information about every cell in form of object.. And sheetDB is of fixed size
...
bold.addEventListener("click",(e)=>{
    ...
    bold.style.backgroundColor = cellProp.bold? activeColorProp : inactiveColorProp;  //changing bold icon background
...
align.forEach((alignElem)=>{      // cell property align element
    alignElem.addEventListener("click",(e)=>{
        let add = addBar.value;
        let[cell,cellProp] =  getActiveCell(add)
    
        let alignValue = e.target.classList[1];  // align value - centre | left | right that is given in form of class to element on index no. 1.
